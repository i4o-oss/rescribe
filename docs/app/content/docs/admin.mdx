...
You probably don’t want your users to visit and get access to the admin UI. To do this, you can use the `redirect` function from Remix when `NODE_ENV === ‘production’`. Update the loader function in `rescribe.$.tsx`: 
